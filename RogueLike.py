...
def create_character():
    ...
    while True:
        ...
        if all(x.isalpha() or x.isspace() for x in player_name):
            ...
            for i in string_answer_valid_name:
                sys.stdout.write(i)
                sys.stdout.flush()
                time.sleep(.03)
            break
            ...
            for i in string_answer_invalid_name:
                sys.stdout.write(i)
                sys.stdout.flush()
                time.sleep(.03)
    ...
    string_ask_attribute_distribution = ("\n" + "Now that we see what you can do, "
                                         ...
                                         + "\n" + "So choose wisely!" + "\n")
    for i in string_ask_attribute_distribution:
        sys.stdout.write(i)
        sys.stdout.flush()
        time.sleep(.03)
    ...
    while available_attribute_points > 0:
        ...
        for i in string_ask_target_attribute:
            sys.stdout.write(i)
            sys.stdout.flush()
            time.sleep(.03)
        ...
        if target_attribute == "STR":
            while True:
                    ...
                    for i in string_ask_str_increase_size:
                        sys.stdout.write(i)
                        sys.stdout.flush()
                        time.sleep(.03)
                    try:
                        ...
                        for i in string_invalid_stat_increase_response:
                            sys.stdout.write(i)
                            sys.stdout.flush()
                            time.sleep(.03)
            ...
            while True:
                    ...
                    for i in string_ask_dex_increase_size:
                        sys.stdout.write(i)
                        sys.stdout.flush()
                        time.sleep(.03)
                    try:
            ...
            while True:
                    string_ask_int_increase_size = ("\n" + "How many points do you wish to assign to intelligence?"
                                                    + "\n")
                    for i in string_ask_int_increase_size:
                        sys.stdout.write(i)
                        sys.stdout.flush()
                        time.sleep(.03)
                    try:
            ...
            while True:
                    ...
                    for i in string_ask_sta_increase_size:
                        sys.stdout.write(i)
                        sys.stdout.flush()
                        time.sleep(.03)
                    try:
